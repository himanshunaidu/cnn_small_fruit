...
test_saver = open('<PATH>/TempF5/test.txt', 'a+')
...
with tf.Session() as sess:
    ...
    for i in range((actual_steps-runs), steps):
        ...
        print("ACCURACY: ")
        get_acc = sess.run(acc, feed_dict={x_image:test_x, y_true:test_y, pool_prob:1.0, hold_prob:1.0})
        print(get_acc)
...
time_saver = open('<PATH>/TempF5/time.txt', 'a+')
